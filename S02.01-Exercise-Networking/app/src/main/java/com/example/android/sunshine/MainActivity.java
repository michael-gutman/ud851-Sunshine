...
public class MainActivity extends AppCompatActivity {
    ...
    public class WeatherQueryTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                String result = NetworkUtils.getResponseFromHttpUrl(searchURL);
                String[] simpleWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, result);
