...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] weatherData = {"Warm", "Rainy", "Hot", "Freezing", "Snowing", "Heat Wave", "Warm", "Rainy", "Hot", "Freezing", "Snowing", "Heat Wave", "Warm", "Rainy", "Hot", "Freezing", "Snowing", "Heat Wave", "Warm", "Rainy", "Hot", "Freezing", "Snowing", "Heat Wave"};
